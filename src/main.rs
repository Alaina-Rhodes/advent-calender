...
fn four() {
    use twenty_three::four::day_four;
    let day_four_data = String::from("Card   1: 84 17 45 77 11 66 94 28 71 70 | 45 51 86 83 53 58 64 30 67 96 41 89  8 17 33 50 80 84  6  2 87 72 27 63 77
...
Card 216: 43 38 30 79 14 47 64  5  8 50 | 70 26 63 98 86 20 59 74  3 41 34 49 78 28 55 67 89 68 60 39 54 94 33 44 80");
    let results = day_four::test(&day_four_data);
    assert_eq!(results, (23941, 5571760));
    println!("Day Four SUCCESSFUL");
}

fn five() {
    use twenty_three::five::day_five;
    let day_five_data = String::from("seeds: 630335678 71155519 260178142 125005421 1548082684 519777283 4104586697 30692976 1018893962 410959790 3570781652 45062110 74139777 106006724 3262608046 213460151 3022784256 121993130 2138898608 36769984
...
fn seven() {
    use twenty_three::seven::day_seven;
    let day_seven_data = String::from("JJJJJ 435
29QA4 847
6A9A9 348
TKQKT 260
J3J58 486
...
53543 530
77373 43");
    let results = day_seven::test(&day_seven_data);
    assert_eq!(results, (249638405, 249776650));
    println!("Day Seven SUCCESSFUL");
}

fn eight() {
    use twenty_three::eight::day_eight;
    let day_eight_data = String::from("
...
SHP = (BKL, SKR)
QXB = (KRM, SVX)");
    let results = day_eight::test(&day_eight_data);
    assert_eq!(results, (12643, 13133452426987));
    println!("Day Eight SUCCESSFUL");
}